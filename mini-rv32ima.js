...
function findWasmBinary() {
    return locateFile('mini-rv32ima.wasm');
}
...
var _w25q_cmd = Module['_w25q_cmd'] = makeInvalidEarlyAccess('_w25q_cmd');
...
function assignWasmExports(wasmExports) {
  ...
  Module['_w25q_cmd'] = _w25q_cmd = createExportWrapper('w25q_cmd', 2);
